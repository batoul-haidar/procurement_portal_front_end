...
const apiUrl = 'http://localhost:8080/procurement_portal_back_end/api/listHistoryByTechnician'; // Replace with your API URL
let currentPage = 1;
let perPage = 10;
let allUsers = [];
    ...
    function renderTable() {
       ...
       if (req.requestStatus === 'Closed'){
                actionsTd.textContent = 'Request is Closed';
            }
